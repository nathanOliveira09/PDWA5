CREATE TABLE IF NOT EXISTS categories (
  guid varchar(36) default (uuid()) NOT NULL,
...
CREATE TABLE IF NOT EXISTS products (
  ...
  created datetime NOT NULL,
  modified timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT PK_Products PRIMARY KEY (id,guid)
...
CREATE TABLE IF NOT EXISTS stores (
  ...
  created datetime NOT NULL,
  modified timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT PK_uuid PRIMARY KEY (id)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;

INSERT INTO stores (name, address, cnpj, created) VALUES
('Matriz - São Paulo', 'Rua Pedro Vicente, 625', '86146153000167', '2022-11-12 14:59:15');

CREATE TABLE IF NOT EXISTS images (
  id int(11) NOT NULL AUTO_INCREMENT,
  image longblob NOT NULL,
  product_id int(11) NOT NULL FOREIGN KEY REFERENCES product(id),
